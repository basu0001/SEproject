...
use Modules\RolePermission\Entities\iiitPermissionAssign;
class GlobalVariable{
	...
	public static function GlobarModuleLinks(){
        try {
            ...
            $permissions = iiitPermissionAssign::where('role_id', Auth::user()->role_id)->where('school_id', Auth::user()->school_id)->get();
