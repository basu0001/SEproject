...
class ApiSmMarksGradeController extends Controller
{
    ...
    {        
        try{
            $marks_grades = SmMarksGrade::orderBy('gpa', 'desc')->where('academic_id', YearCheck::getAcademicId())->get();
    ...
    {       
        try{
            ...
            $marks_grades = SmMarksGrade::where('academic_id', YearCheck::getAcademicId())->get();
