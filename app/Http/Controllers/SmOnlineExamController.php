...
class SmOnlineExamController extends Controller
{
    ...
    public function index()
    {
        ...
        try{
            $online_exams = SmOnlineExam::where('status', '!=', 2)->where('academic_id', YearCheck::getAcademicId())->where('school_id',Auth::user()->school_id)->get();
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            $online_exam->academic_id = YearCheck::getAcademicId();
            $result = $online_exam->save();
            if ($result) {
                // $data = SmStudent::where('class_id', $request->class)->where('section_id', $request->section)->where('academic_id', YearCheck::getAcademicId())->where('school_id',Auth::user()->school_id)->get();
                // if (!empty($data)) {
    ...
    public function manageOnlineExamQuestion($id)
    {
        ...
        try{
            $online_exam = SmOnlineExam::find($id);
            $question_banks = SmQuestionBank::where('class_id', $online_exam->class_id)->where('section_id', $online_exam->section_id)->where('academic_id', YearCheck::getAcademicId())->where('school_id',Auth::user()->school_id)->get();

            $assigned_questions = SmOnlineExamQuestionAssign::where('online_exam_id', $id)->where('academic_id', YearCheck::getAcademicId())->where('school_id',Auth::user()->school_id)->get();
            $already_assigned = [];
    ...
    public function manageOnlineExamQuestionStore(Request $request)
    {
        ...
        try{
            if ($request->question_type != 'M') {
                ...
                $online_question->academic_id = YearCheck::getAcademicId();
                ...
                try {
                    ...
                    if (isset($request->option)) {
                        foreach ($request->option as $option) {
                            ...
                            $online_question_option->academic_id = YearCheck::getAcademicId();
    ...
    public function onlineExamPublish($id)
    {
        ...
        try{
            ...
            $students = SmStudent::where('class_id', $class_id)->where('section_id', $section_id)->where('academic_id', YearCheck::getAcademicId())->where('school_id',Auth::user()->school_id)->get();
    ...
    public function onlineExamMarksRegister($id)
    {
        ...
        try{
            ...
            $students = SmStudent::where('class_id', $online_exam_question->class_id)->where('section_id', $online_exam_question->section_id)->where('academic_id', YearCheck::getAcademicId())->where('school_id',Auth::user()->school_id)->get();
            $present_students = [];
            foreach ($students as $student) {
    ...
    public function onlineExamMarksStore(Request $request)
    {
        ...
        try{
            ...
            foreach ($request->students as $student) {
                ...
                $online_mark->academic_id = YearCheck::getAcademicId();
        ...
        try{
            ...
            if (isset($request->questions)) {
                foreach ($request->questions as $question) {
                    ...
                    $assign->academic_id = YearCheck::getAcademicId();
                    $assign->save();
                }
                Toastr::success('Operation successful', 'Success');
                return redirect('online-exam');
    ...
    public function onlineExamMarking($exam_id, $s_id)
    {
        ...
        try{
            $take_online_exam = SmStudentTakeOnlineExam::where('online_exam_id', $exam_id)->where('student_id', $s_id)->where('academic_id', YearCheck::getAcademicId())->first();
    ...
    public function onlineExamMarkingStore(Request $request)
    {
        ...
        try{
            $online_take_exam_mark = SmStudentTakeOnlineExam::where('online_exam_id', $request->online_exam_id)->where('student_id', $request->student_id)->where('academic_id', YearCheck::getAcademicId())->first();
            $total_marks = 0;
            if (isset($request->marks)) {
                foreach ($request->marks as $mark) {
                    $question_marks = SmQuestionBank::select('marks')->where('id', $mark)->where('academic_id', YearCheck::getAcademicId())->first();
    ...
    public function onlineExamReport(Request $request)
    {
        ...
        try{
            $exams = SmOnlineExam::where('active_status', 1)->where('academic_id', YearCheck::getAcademicId())->where('school_id',Auth::user()->school_id)->get();
            $classes = SmClass::where('active_status', 1)->where('academic_id', YearCheck::getAcademicId())->where('school_id',Auth::user()->school_id)->get();
    ...
    public function onlineExamReportSearch(Request $request)
    {
        ...
        try{
            ...
            $students = SmStudent::where('class_id', $request->class)->where('section_id', $request->section)->where('academic_id', YearCheck::getAcademicId())->where('school_id',Auth::user()->school_id)->get();
