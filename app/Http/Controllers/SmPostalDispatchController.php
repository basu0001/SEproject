...
class SmPostalDispatchController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try{
            $postal_dispatchs = SmPostalDispatch::where('school_id',Auth::user()->school_id)->where('academic_id', YearCheck::getAcademicId())->get();
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            $postal_dispatch->academic_id = YearCheck::getAcademicId();
    ...
    public function show(Request $request, $id)
    {
        ...
        try{
            $postal_dispatchs = SmPostalDispatch::where('academic_id', YearCheck::getAcademicId())->where('school_id',Auth::user()->school_id)->get();
