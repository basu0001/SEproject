...
class SmQuestionBankController extends Controller
{
    ...
    {
        try{
            $levels = SmQuestionLevel::where('active_status', 1)->where('academic_id', YearCheck::getAcademicId())->where('school_id',Auth::user()->school_id)->get();
            $groups = SmQuestionGroup::where('active_status', 1)->where('academic_id', YearCheck::getAcademicId())->where('school_id',Auth::user()->school_id)->get();
            $banks = SmQuestionBank::where('active_status', 1)->where('academic_id', YearCheck::getAcademicId())->where('school_id',Auth::user()->school_id)->get();
    ...
    {
        try {
            $levels = SmQuestionLevel::where('academic_id', YearCheck::getAcademicId())->where('school_id',Auth::user()->school_id)->get();
            $groups = SmQuestionGroup::where('academic_id', YearCheck::getAcademicId())->where('school_id',Auth::user()->school_id)->get();
            $banks = SmQuestionBank::where('academic_id', YearCheck::getAcademicId())->where('school_id',Auth::user()->school_id)->get();
