    ...
    public function classReportSearch(Request $request)
    {
        ...
        try {
            ...
            foreach ($students as $student) {
                ...
                $applied_discount+=SmFeesAssignDiscount::where('student_id',$student->id)->sum('applied_amount');
            }
            ...
            return view('backEnd.reports.class_report', compact('classes', 'students','applied_discount', 'assign_subjects', 'assign_class_teachers', 'total_collection', 'total_assign', 'class', 'section'));
        } catch (\Exception $e) {
            dd($e);
            Toastr::error('Operation Failed', 'Failed');
            return redirect()->back();
