...
class SmPostalReceiveController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try{
            $postal_receives = SmPostalReceive::where('school_id',Auth::user()->school_id)->where('academic_id', YearCheck::getAcademicId())->get();
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            $postal_receive->academic_id = YearCheck::getAcademicId();
