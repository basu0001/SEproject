...
class SmPhoneCallLogController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try{
            $phone_call_logs = SmPhoneCallLog::where('academic_id', YearCheck::getAcademicId())->where('school_id',Auth::user()->school_id)->get();
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            $phone_call_log->academic_id = YearCheck::getAcademicId();
