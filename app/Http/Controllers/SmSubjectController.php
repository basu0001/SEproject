...
class SmSubjectController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            $subjects = SmSubject::where('active_status', 1)->orderBy('id', 'DESC')->where('school_id', Auth::user()->school_id)->where('academic_id', YearCheck::getAcademicId())->get();
    ...
    public function edit(Request $request, $id)
    {
        ...
        try {
            ...
            $subjects = SmSubject::where('active_status', 1)->orderBy('id', 'DESC')->where('academic_id', YearCheck::getAcademicId())->where('school_id', Auth::user()->school_id)->get();
