                ...
                <div class="col-lg-12">
                    <div class="white-box">
                            ...
                            <div class="row mt-40">
                                <div class="col-lg-12">
                                    <div class="input-effect">
                                        <input class="primary-input form-control{{ $errors->has('durration') ? ' is-invalid' : '' }}"
                                        type="number" name="durration" autocomplete="off" value="{{isset($editData)? @$editData->topic : old('topic')}}">
