...
Route::group(['middleware' => ['XSS']], function () {
    //api url http://localhost/project/101.iiitedu.v4/api/send-sms?phonenumber=+88017648456&sender_id=1&api_password=978&api_id=2&sms_type=2&encoding=ty&textmessage=yu
    ...
    // https://iiitedu.com/api/search-student?class=2
    // https://iiitedu.com/api/search-student?section=1&class=2
    // https://iiitedu.com/api/search-student?name=Conner Stamm
    // https://iiitedu.com/api/search-student?roll_no=28229
    ...
    //iiitedu.com/android/api/group-token?id=2&body=Notification body&title=Notification title
