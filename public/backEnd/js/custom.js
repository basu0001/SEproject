(function($) {
    ...
    $(document).ready(function() {
        $("#btn-assign-fees-discount").on("click", function() {
            ...
            for (var prop in abc) {
                ...
                if (get_master_id=='') {
                    setTimeout(function() {
                        toastr.warning("Please select fees type/group for selected student !", "Warning", {
                            timeOut: 5000,
                        });
                    }, 500);
                    return false;
    ...
    $(document).ready(function () {
        ...
        $("form#student_form #academic_year, form#infix_form #academic_year").on('change', function () {
            var url = $('#url').val();
