    ...
    <div class="container-fluid p-0">
        ...
        <div class="row">
            <div class="offset-lg-10 col-lg-2 text-right col-md-12 mb-20">
                <a href="<?php echo e(url('fees-master')); ?>" class="primary-btn small fix-gr-bg">
                                    ...
                                    <div class="col-lg-12">
                                        <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('fees_type') ? ' is-invalid' : ''); ?>" name="fees_type">
                                            ...
                                            <?php if(!in_array($fees_type->id, $already_assigned)): ?>
                                                <?php if(isset($fees_master)): ?>
                                                    <option value="<?php echo e($fees_type->id); ?>" <?php echo e($fees_type->id == $fees_master->fees_type_id? 'selected':'fgdf'); ?>><?php echo e(@$fees_type->name); ?></option>
                                                <?php else: ?>
                                                ...
                                                <div class="dropdown mb-20">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                       <?php if(in_array(120, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                                                        ...
                                                        <a class="dropdown-item" href="<?php echo e(url('fees-master', [$fees_master->id])); ?>"><?php echo app('translator')->get('lang.edit'); ?></a>
                                                       <?php endif; ?>
                                    ...
                                    <td valign="top">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <?php endif; ?>
                                                <a class="dropdown-item deleteFeesMasterGroup" data-toggle="modal" href="#" data-id="<?php echo e($fees_master->fees_group_id); ?>" data-target="#deleteFeesMasterGroup"><?php echo app('translator')->get('lang.delete'); ?></a>
                                            </div>
                                        </div>
                                        <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Server3\htdocs\spondon\infixedu_lv7.0_rv_4.5\resources\views/backEnd/feesCollection/fees_master.blade.php ENDPATH**/ ?>