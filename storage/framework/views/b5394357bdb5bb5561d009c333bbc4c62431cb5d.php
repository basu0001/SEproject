                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 mt-30-md infix_up_mt">
                                    <div class="input-effect">
                                        ...
                                        <label><?php echo app('translator')->get('lang.search_by_name'); ?>, <?php echo app('translator')->get('lang.admission'); ?> <?php echo app('translator')->get('lang.no'); ?>, <?php echo app('translator')->get('lang.roll'); ?> <?php echo app('translator')->get('lang.no'); ?>, <?php echo app('translator')->get('lang.national_iD_number'); ?>, <?php echo app('translator')->get('lang.local_Id_Number'); ?></label>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Server3\htdocs\spondon\infixedu_lv7.0_rv_4.5\resources\views/backEnd/feesCollection/collect_fees.blade.php ENDPATH**/ ?>