...
<div class="container-fluid">
    ...
    <form method="POST" class="" action="<?php echo e(url('fees-payment-stripe-store')); ?>" id="subscription-payment" data-cc-on-file="false" data-stripe-publishable-key="<?php echo e(@$stripe_info->gateway_publisher_key); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="row">
            <div class="col-lg-12">
                         ...
                         <div class="row">                                              
                                    <div class="col-lg-6 mt-20">
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('lang.name_on_card'); ?>  <span>*</span></label>
                                    ...
                                    <div class="col-lg-6 mt-20">
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('lang.card_number'); ?>  <span>*</span></label>
                                            <span class="focus-border"></span> 
                                        </div>
                                ...
                                <div class="row mt-20">                                              
                                    <div class="col-lg-4 mt-20">
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('lang.CVC'); ?>  <span>*</span></label>
                                            <span class="focus-border"></span> 
                                        </div>
                                    </div>
                                    <div class="col-lg-4 mt-20">
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('lang.expiration_month'); ?>  <span>*</span></label>
                                            <span class="focus-border"></span> 
                                        </div>
                                    ...
                                    <div class="col-lg-4 mt-20">
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('lang.expiration_year'); ?>  <span>*</span></label>
                                            <span class="focus-border"></span> 
                                        </div>                            
                                    </div>
...
<?php /**PATH E:\Server3\htdocs\spondon\infixedu_lv7.0_rv_4.5\resources\views/backEnd/studentPanel/stripe_payment.blade.php ENDPATH**/ ?>