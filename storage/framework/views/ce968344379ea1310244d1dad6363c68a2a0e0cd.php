    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="#"><?php echo app('translator')->get('lang.action'); ?></a>
            </div>
        </div>
    </div>
</section>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Server3\htdocs\spondon\infixedu_lv7.0_rv_4.5\resources\views/backEnd/academics/section.blade.php ENDPATH**/ ?>